...
Receiving objects: 100% (221/221), 1.01 MiB | 2.23 MiB/s, done.
...
installation directory:
    ...
    [Errno 13] Permission denied: '/usr/local/lib/python3.11/dist-packages/test-easy-install-79897.write-test'
...
Descargamos el archivo pero es un audio, lo necesitamos desencriptar asi que buscamos un sstv decripter, abrimos el de github lo instalamos y le damos permisos como admin, y lo usamos:
...
## Notas adicionales
Aprendi a desencriptar un audio a texto, como lo hacian antes en la luna
## Referencias
